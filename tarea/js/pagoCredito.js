...
creditCard && alert(`El monto original es de ${ammount} pesos.
Usted eligió pagar en ${installements} cuotas de ${totalAmount / installements} pesos.
El monto total a pagar es de ${totalAmount} pesos.`);